...
import lk.ijse.orm.util.Navigation;
import lk.ijse.orm.util.Routes;
...
public class DashBoardFormController {
    ...
    private void setUI(String URI) throws IOException {
        ...
        Parent parent = FXMLLoader.load(getClass().getResource("/lk/ijse/orm/view/" +URI+".fxml"));
    ...
    public void btnLogOutOnAction(ActionEvent actionEvent) throws IOException {
        ...
        stage1.close();
        URL resource = getClass().getResource("/lk/ijse/orm/view/LoginForm.fxml");
